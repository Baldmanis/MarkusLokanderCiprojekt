...
public class stepDefinitions {
    ...
    @Before
    public void startBrowser() {  //Startar webbläsaren som idetta fall är Chrome men man kan även lägga till firefox eller andra om man lägger in fler drivers
    ...
    @Given("I have entered {string}") //Lägger in ett Email som används från ens
    ...
    public void i_press_sign_up() {
        ...
        WebElement checkbox = driver.findElement(By.cssSelector("#marketing_newsletter"));
